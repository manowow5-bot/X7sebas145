    ...
    return `
      <div class="${cardClass}">
        ...
        <div class="card-thumb">
          <iframe
            src="https://www.youtube-nocookie.com/embed/QVs0WPXebUU?autoplay=1&mute=1&loop=1&playlist=QVs0WPXebUU&controls=0&modestbranding=1&rel=0"
        ...
        <div class="card-body">
          <p class="card-tag">Disponible en: ${plan.duration}</p>
          <div class="price">Desde $${plan.price} USD</div>
          <div class="stock-badge" style="color: ${stock > 0 ? '#10b981' : '#ef4444'}">
            ${stock > 0 ? `✓ ${stock} disponibles` : '✗ Sin stock'}
          </div>
          <ul class="features">
            <li>✓ Activacion inmediata</li>
            <li>✓ Soporte 24/7</li>
            <li>✓ Actualizaciones activas</li>
            <li>✓ Compra segura</li>
          </ul>
        </div>
...
function updateStockInfo() {
  ...
  // Se oculta el resumen global para mostrar stock solo en cada tarjeta.
  stockInfo.innerHTML = "";
}
